...
TEST_CASE("[System]") {
	...
	class ComponentAltererObservable :
		public ska::Observable<const ska::EntityEventType, const ska::EntityComponentsMask&, ska::EntityId> {
	};
	...
	SUBCASE("int std::string required, double possible") {
		...
		//Describes an entity with 2 components with respectively component id 1 and 2 (here, those are int and std::string component ids)
